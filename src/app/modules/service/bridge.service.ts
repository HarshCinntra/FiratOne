...
export class BridgeService {
  ...
  // baseUrl2 = 'http://192.168.29.112:8002';
  // SuperbaseUrl = 'http://192.168.29.112:8000/api';
...
replaceKeyInArray(arr: any[], oldKey: string, newKey: string): any[] {
  ...
  reportDetails(id:any){
    return this.http.post(`${this.baseUrl2}/mis_reports/view_report`, {"report_id": id}, { 'headers': this.getHeader() }).pipe(
      map((res: any) => {
        // //console.log(res)
        return res;
      })
